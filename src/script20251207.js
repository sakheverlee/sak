let data20251207 = [
    ...
    ['1962', '*-2-3',     '<a href=src/missing.html>          <img src="src/missing.jpg" width="20" height="20"></img> </a>',  ' ', ' ' , '' , 'Advent dat is'                   ],
    ...
    ['1653', 'alles',     '<a href=src/missing.html>          <img src="src/missing.jpg" width="20" height="20"></img> </a>',  ' ', ' ' , '' , 'Bereid de weg des Heren'            ],
    ['0537', 'alles',     '<a href=coria/0537_Heilig.html>                   <img src="src/quaver.svg" width="20" height="20"></img> </a>',  ' ', ' ' , '' , 'Heilig'                             ],
    ['0690', '1-2',       '<a href=src/missing.html>          <img src="src/missing.jpg" width="20" height="20"></img> </a>',  ' ', ' ' , '' , 'Vrede voor iedereen'                ],
    ['1577', '1-2',       '<a href=src/missing.html>          <img src="src/missing.jpg" width="20" height="20"></img> </a>',  ' ', ' ' , '' , 'Effen de weg'                       ],
