let data20251214 = [
    ...
    ['1244', 'alles',     '<a href=src/missing.html>          <img src="src/missing.jpg" width="20" height="20"></img> </a>',  ' ', ' ' , '' , 'Lied om vergeving'                     ],
    ['0426', '1-2-3-4',   '<a href=src/missing.html>          <img src="src/missing.jpg" width="20" height="20"></img> </a>',  ' ', ' ' , '' , 'Wanneer zal de mens toch komen'        ],
    ['0394', 'alles',     '<a href=src/missing.html>          <img src="src/missing.jpg" width="20" height="20"></img> </a>',  ' ', ' ' , '' , 'Blijf niet staren'                     ],
    ...
    ['0422', '1-2',       '<a href=src/missing.html>          <img src="src/missing.jpg" width="20" height="20"></img> </a>',  ' ', ' ' , '' , 'Blijf niet staan'                      ]
];
